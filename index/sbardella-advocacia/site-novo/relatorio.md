...
| :--- | :--- | :--- | :--- |
| **Performance Mobile** | **38/100** (LCP 5.2s) | **Instantânea** (<0.8s) | Retenção máxima de tráfego 4G |
...
> **Antes:** *"Escritório boutique com clientes de alto tíquete imobiliário, mas com site lento, layout genérico de 2017 e perda de leads qualificados no smartphone."*  
> **Depois:** O redesign posiciona a **Sbardella Advocacia** com a imponência e rigor estético compatíveis com uma das principais bancas de Direito Imobiliário & Planejamento Sucessório / Holdings de Florianópolis.
...
- **Código do Site:** `leads/sbardella-advocacia/redesign/site/index.html` (com `styles.css` e `script.js`)
