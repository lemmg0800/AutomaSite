# Relatório de Transformação Digital & Redesign — Duka Painéis e Imagens

**Data de Conclusão:** 18/09/2026  
**Segmento:** Painéis Industriais, Letras Caixa & Luminosos em Acrílico  
**Localização:** Içara - SC  
**Site Original:** [http://dukapaineis.com.br/](http://dukapaineis.com.br/)  
...
| :--- | :--- | :--- | :--- |
| **Performance Mobile** | **39/100** (LCP 5.1s) | **Instantânea** (<0.8s) | Retenção máxima de tráfego 4G |
...
> **Antes:** *"Estrutura industrial de grande porte no Distrito Industrial, mas com presença web que aparenta pequeno prestador sem maquinário próprio."*  
> **Depois:** O redesign posiciona a **Duka Painéis e Imagens** com a imponência e rigor estético compatíveis com uma das principais bancas de Painéis Industriais, Letras Caixa & Luminosos em Acrílico de Florianópolis.
...
- **Como era:** Site original demorava mais de 5.1s para interagir no mobile.
...
- **Código do Site:** `leads/duka-paineis-e-imagens/redesign/site/index.html` (com `styles.css` e `script.js`)
