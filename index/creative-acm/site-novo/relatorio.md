# Relatório de Transformação Digital & Redesign — Creative ACM Comunicação Visual

**Data de Conclusão:** 18/09/2026  
**Segmento:** Fachadas em ACM, Letreiros Luminosos & Estruturas Metálicas  
**Localização:** Criciúma - SC  
**Site Original:** [https://creativeacm.com.br/](https://creativeacm.com.br/)  
...
| :--- | :--- | :--- | :--- |
| **Performance Mobile** | **34/100** (LCP 5.6s) | **Instantânea** (<0.8s) | Retenção máxima de tráfego 4G |
...
> **Antes:** *"Empresa referência em obras de fachadas comerciais e ACM de alto ticket, mas com site lento que desvaloriza o acabamento visual dos projetos entregues."*  
> **Depois:** O redesign posiciona a **Creative ACM Comunicação Visual** com a imponência e rigor estético compatíveis com uma das principais bancas de Fachadas em ACM, Letreiros Luminosos & Estruturas Metálicas de Florianópolis.
...
- **Como era:** Site original demorava mais de 5.6s para interagir no mobile.
...
- **Código do Site:** `leads/creative-acm/redesign/site/index.html` (com `styles.css` e `script.js`)
