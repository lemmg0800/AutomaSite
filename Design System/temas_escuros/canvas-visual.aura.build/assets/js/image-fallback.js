/*
 * Fallback para imagens quebradas: substitui `src` por uma das imagens
 * em CDN (escolhida deterministicamente via hash do src original).
 */
!function () {
  var f = [
  ...
  function r(t) {
    var s = t.src;
    if (s && !h.has(s)) { h.add(s); t.src = g(s); }
  }
