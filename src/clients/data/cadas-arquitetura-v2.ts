...
const client: ClientConfig = {
  slug: 'cadas-arquitetura-v2',
  status: 'published',
  createdAt: '2026-09-20T23:29:34.693Z',
  updatedAt: '2026-09-20T23:29:34.693Z',
  business: {
  ...
  pages: [
    {
      ...
      seo: {
        ...
        ogImage: '/assets/clients/cadas-arquitetura-v2/obra_lw.jpg'
      },
      sections: [
        {
          id: 'header-cadas',
        ...
        },
        {
          ...
          content: {
            ...
            imageUrl: '/assets/clients/cadas-arquitetura-v2/obra_lw.jpg'
          }
        },
        {
          id: 'projects-cadas',
