# Relatório de Transformação Digital & Redesign — Dr. Marcos Carvalho Implantodontia

**Data de Conclusão:** 19/09/2026  
**Segmento:** Implantodontia com Carga Imediata & Cirurgia Guiada  
**Localização:** Manaus - AM  
**Site Original:** [https://drmarcoscarvalho.com.br/](https://drmarcoscarvalho.com.br/)  
...
| :--- | :--- | :--- | :--- |
| **Performance Mobile** | **33/100** (LCP 5.4s) | **Instantânea** (<0.8s) | Retenção máxima de tráfego 4G |
...
> **Depois:** O redesign posiciona a **Dr. Marcos Carvalho Implantodontia** com a imponência e rigor estético compatíveis com uma das principais bancas de Implantodontia com Carga Imediata & Cirurgia Guiada de Florianópolis.
...
- **Código do Site:** `leads/dr-marcos-carvalho/redesign/site/index.html` (com `styles.css` e `script.js`)
