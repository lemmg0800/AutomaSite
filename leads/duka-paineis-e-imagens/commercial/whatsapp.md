# Scripts de Contato via WhatsApp: Duka Painéis e Imagens

## Opção A: Abordagem com Pedido de Permissão (Recomendada para tom mais consultivo)

Oi, tudo bem?

Dei uma olhada no site da **Duka Painéis e Imagens** enquanto pesquisava referências em Painéis Industriais, Letras Caixa & Luminosos em Acrílico aqui em Içara - SC.
...
Estava olhando o site da **Duka Painéis e Imagens** e percebi uma diferença grande entre a qualidade do trabalho de vocês e a forma como ele é apresentado hoje no site (principalmente no celular, onde o contato demora para carregar).

Para não ficar só na teoria, montei uma versão demonstrativa para vocês:
👉 https://meudominio.com/preview/duka-paineis-e-imagens
