# ESTRUTURA VISUAL E CONTEÚDO DO SITE ORIGINAL: Duka Painéis e Imagens
...
- **Empresa:** Duka Painéis e Imagens
- **URL Original:** http://dukapaineis.com.br/
- **Visual Quality Score:** 6.2/10 (B — BOM, MAS DESATUALIZADO)
- **Redesign Opportunity Score:** 58/100
- **Fotos Reais Identificadas:** 61 imagens
...
- **Headline Identificada:** "Duka Painéis e Imagens — Especialistas em Painéis Industriais, Letras Caixa & Luminosos em Acrílico"
...
- **Título da Seção:** "Por que escolher a Duka Painéis e Imagens?"
...
- **Elementos:** Endereço físico completo (Rua Luiza Barp, 230 - Distrito Industrial 1ª Linha, Içara / Criciúma - SC), WhatsApp direto, telefone fixo, e-mail comercial e mapa de atendimento.
- **CTA Final:** "Solicite um Orçamento sem Compromisso".

---

## 3. DIRETRIZES MANDATÓRIAS PARA O BUILDER
1. **PRESERVAR:** Fotografias reais do acervo da empresa (61 fotos reais catalogadas); Paleta de cores institucional autêntica e logotipo original; Histórico, segmento de atuação e autoridade comprovada no mercado regional; Lista legítima de especialidades e projetos executados.
