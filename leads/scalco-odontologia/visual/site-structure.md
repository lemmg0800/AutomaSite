# ESTRUTURA VISUAL E CONTEÚDO DO SITE ORIGINAL: Scalco Odontologia Estética
...
- **Empresa:** Scalco Odontologia Estética
- **URL Original:** https://scalcoodontologia.com.br/
...
- **Headline Identificada:** "Scalco Odontologia Estética — Especialistas em Facetas de Porcelana, Lentes & Clareamento Dental"
...
- **Título da Seção:** "Por que escolher a Scalco Odontologia Estética?"
...
- **Elementos:** Endereço físico completo (Av. Ayrton Senna da Silva, 550 - Gleba Palhano, Londrina - PR), WhatsApp direto, telefone fixo, e-mail comercial e mapa de atendimento.
...
3. **NÃO REGRESSÃO:** É expressamente proibido trocar fotos reais por ilustrações ou mockups sem foto. O novo Hero precisa igualar ou superar nota 5.7/10.
