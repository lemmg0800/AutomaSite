# ESTRUTURA VISUAL E CONTEÚDO DO SITE ORIGINAL: Studio Amazon Odontologia Digital
...
- **URL Original:** https://studioamazonodontologia.com.br/
- **Visual Quality Score:** 6.5/10 (B — BOM, MAS DESATUALIZADO)
- **Redesign Opportunity Score:** 62/100
- **Fotos Reais Identificadas:** 8 imagens
...
- **Headline Identificada:** "Studio Amazon Odontologia Digital — Especialistas em Fluxo 100% Digital CAD/CAM & Laboratório Próprio"
...
- **Título da Seção:** "Por que escolher a Studio Amazon Odontologia Digital?"
...
- **Elementos:** Endereço físico completo (Av. Jornalista Umberto Calderaro Filho, 455 - Adrianópolis, Manaus - AM), WhatsApp direto, telefone fixo, e-mail comercial e mapa de atendimento.
- **CTA Final:** "Solicite um Orçamento sem Compromisso".

---

## 3. DIRETRIZES MANDATÓRIAS PARA O BUILDER
1. **PRESERVAR:** Fotografias reais do acervo da empresa (8 fotos reais catalogadas); Paleta de cores institucional autêntica e logotipo original; Histórico, segmento de atuação e autoridade comprovada no mercado regional; Lista legítima de especialidades e projetos executados.
...
3. **NÃO REGRESSÃO:** É expressamente proibido trocar fotos reais por ilustrações ou mockups sem foto. O novo Hero precisa igualar ou superar nota 5.9/10.
