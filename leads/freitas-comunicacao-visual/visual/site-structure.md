# ESTRUTURA VISUAL E CONTEÚDO DO SITE ORIGINAL: Freitas Comunicação Visual
...
- **URL Original:** https://freitascomunicacaovisual.com.br/
- **Visual Quality Score:** 6.2/10 (B — BOM, MAS DESATUALIZADO)
- **Redesign Opportunity Score:** 60/100
- **Fotos Reais Identificadas:** 36 imagens
...
- **Headline Identificada:** "Freitas Comunicação Visual — Especialistas em Fachadas em ACM, Letras Caixa, Painéis & Outdoors"
...
- **Título da Seção:** "Por que escolher a Freitas Comunicação Visual?"
...
- **Elementos:** Endereço físico completo (Rua Linha Três Ribeirões, 600 - Centenário, Içara / Criciúma - SC), WhatsApp direto, telefone fixo, e-mail comercial e mapa de atendimento.
- **CTA Final:** "Solicite um Orçamento sem Compromisso".

---

## 3. DIRETRIZES MANDATÓRIAS PARA O BUILDER
1. **PRESERVAR:** Fotografias reais do acervo da empresa (36 fotos reais catalogadas); Paleta de cores institucional autêntica e logotipo original; Histórico, segmento de atuação e autoridade comprovada no mercado regional; Lista legítima de especialidades e projetos executados.
