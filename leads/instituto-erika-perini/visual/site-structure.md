# ESTRUTURA VISUAL E CONTEÚDO DO SITE ORIGINAL: Instituto Erika Perini Odontologia
...
- **Empresa:** Instituto Erika Perini Odontologia
- **URL Original:** https://odontopediatriamanaus.com.br/
- **Visual Quality Score:** 6.4/10 (B — BOM, MAS DESATUALIZADO)
...
- **Headline Identificada:** "Instituto Erika Perini Odontologia — Especialistas em Odontopediatria, Ortodontia Preventiva & Laserterapia"
...
- **Título da Seção:** "Por que escolher a Instituto Erika Perini Odontologia?"
...
- **Elementos:** Endereço físico completo (Av. Mário Ypiranga, 315, Sala 801 - Adrianópolis, Manaus - AM), WhatsApp direto, telefone fixo, e-mail comercial e mapa de atendimento.
...
3. **NÃO REGRESSÃO:** É expressamente proibido trocar fotos reais por ilustrações ou mockups sem foto. O novo Hero precisa igualar ou superar nota 5.8/10.
