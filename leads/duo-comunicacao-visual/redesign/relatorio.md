# Relatório de Transformação Digital & Redesign — Duo Comunicação Visual

**Data de Conclusão:** 18/09/2026  
**Segmento:** Neon LED, Fachadas Comerciais, Totens & Adesivagem de Frotas  
**Localização:** Içara - SC  
**Site Original:** [https://duoonline.com.br/](https://duoonline.com.br/)  
...
| :--- | :--- | :--- | :--- |
| **Performance Mobile** | **40/100** (LCP 4.8s) | **Instantânea** (<0.8s) | Retenção máxima de tráfego 4G |
...
> **Antes:** *"Alta especialização em projetos criativos e luminosos para varejo moderno, porém site antigo não transmite o impacto visual e brilho dos letreiros."*  
> **Depois:** O redesign posiciona a **Duo Comunicação Visual** com a imponência e rigor estético compatíveis com uma das principais bancas de Neon LED, Fachadas Comerciais, Totens & Adesivagem de Frotas de Florianópolis.
...
- **Código do Site:** `leads/duo-comunicacao-visual/redesign/site/index.html` (com `styles.css` e `script.js`)
