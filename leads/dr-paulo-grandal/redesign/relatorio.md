# Relatório de Transformação Digital & Redesign — Dr. Paulo Grandal Odontologia

**Data de Conclusão:** 19/09/2026  
**Segmento:** Implantes Dentários, Próteses & Urgência 24h  
**Localização:** Manaus - AM  
**Site Original:** [https://drpaulograndal.com.br/](https://drpaulograndal.com.br/)  
...
| :--- | :--- | :--- | :--- |
| **Performance Mobile** | **31/100** (LCP 5.4s) | **Instantânea** (<0.8s) | Retenção máxima de tráfego 4G |
...
> **Depois:** O redesign posiciona a **Dr. Paulo Grandal Odontologia** com a imponência e rigor estético compatíveis com uma das principais bancas de Implantes Dentários, Próteses & Urgência 24h de Florianópolis.
...
- **Código do Site:** `leads/dr-paulo-grandal/redesign/site/index.html` (com `styles.css` e `script.js`)
