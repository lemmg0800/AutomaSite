# ESTRUTURA VISUAL E CONTEÚDO DO SITE ORIGINAL: Poersch & Poersch Advogados Associados
...
- **URL Original:** https://poersch.adv.br/
- **Visual Quality Score:** 6.3/10 (B — BOM, MAS DESATUALIZADO)
- **Redesign Opportunity Score:** 64/100
...
- **Headline Identificada:** "Poersch & Poersch Advogados Associados — Especialistas em Consultoria Empresarial, Direito Administrativo & Contencioso Cível"
...
- **Título da Seção:** "Por que escolher a Poersch & Poersch Advogados Associados?"
...
- **Elementos:** Endereço físico completo (R. Benjamin Constant, 977 - Centro, Rio Branco - AC), WhatsApp direto, telefone fixo, e-mail comercial e mapa de atendimento.
...
3. **NÃO REGRESSÃO:** É expressamente proibido trocar fotos reais por ilustrações ou mockups sem foto. O novo Hero precisa igualar ou superar nota 5.5/10.
