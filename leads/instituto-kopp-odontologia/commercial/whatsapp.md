# Scripts de Contato via WhatsApp: Instituto Kopp Odontologia

## Opção A: Abordagem com Pedido de Permissão (Recomendada para tom mais consultivo)

Oi, tudo bem?

Dei uma olhada no site da **Instituto Kopp Odontologia** enquanto pesquisava referências em Implantodontia Avançada & Carga Imediata aqui em Curitiba - PR.
...
Estava olhando o site da **Instituto Kopp Odontologia** e percebi uma diferença grande entre a qualidade do trabalho de vocês e a forma como ele é apresentado hoje no site (principalmente no celular, onde o contato demora para carregar).
