# Scripts de Contato via WhatsApp: Sbardella Advocacia

## Opção A: Abordagem com Pedido de Permissão (Recomendada para tom mais consultivo)

Oi, tudo bem?

Dei uma olhada no site da **Sbardella Advocacia** enquanto pesquisava referências em Direito Imobiliário & Planejamento Sucessório / Holdings aqui em Florianópolis - SC.
...
Estava olhando o site da **Sbardella Advocacia** e percebi uma diferença grande entre a qualidade do trabalho de vocês e a forma como ele é apresentado hoje no site (principalmente no celular, onde o contato demora para carregar).
