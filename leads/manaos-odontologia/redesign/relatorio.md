# Relatório de Transformação Digital & Redesign — Manaós Odontologia

**Data de Conclusão:** 19/09/2026  
**Segmento:** Clínica Odontológica & Implantes (4 Unidades)  
**Localização:** Manaus - AM  
**Site Original:** [https://manaosodontologia.com.br/](https://manaosodontologia.com.br/)  
...
| :--- | :--- | :--- | :--- |
| **Performance Mobile** | **34/100** (LCP 5.4s) | **Instantânea** (<0.8s) | Retenção máxima de tráfego 4G |
...
> **Depois:** O redesign posiciona a **Manaós Odontologia** com a imponência e rigor estético compatíveis com uma das principais bancas de Clínica Odontológica & Implantes (4 Unidades) de Florianópolis.
...
- **Código do Site:** `leads/manaos-odontologia/redesign/site/index.html` (com `styles.css` e `script.js`)
