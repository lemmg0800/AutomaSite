# Relatório de Transformação Digital & Redesign — Instituto da Face do Amazonas (IFACEAM)

**Data de Conclusão:** 19/09/2026  
**Segmento:** Cirurgia Buco-Maxilo-Facial, DTM & Implantes Complexos  
**Localização:** Manaus - AM  
**Site Original:** [https://ifaceam.com.br/](https://ifaceam.com.br/)  
...
| :--- | :--- | :--- | :--- |
| **Performance Mobile** | **30/100** (LCP 5.4s) | **Instantânea** (<0.8s) | Retenção máxima de tráfego 4G |
...
> **Antes:** *"Clínica de prestígio em Manaus - AM, mas com presença mobile ultrapassada que perde pacientes para concorrentes com sites ultravelozes."*  
> **Depois:** O redesign posiciona a **Instituto da Face do Amazonas (IFACEAM)** com a imponência e rigor estético compatíveis com uma das principais bancas de Cirurgia Buco-Maxilo-Facial, DTM & Implantes Complexos de Florianópolis.
...
- **Como era:** Site original demorava mais de 5.4s para interagir no mobile.
...
- **Código do Site:** `leads/ifaceam-instituto-da-face/redesign/site/index.html` (com `styles.css` e `script.js`)
