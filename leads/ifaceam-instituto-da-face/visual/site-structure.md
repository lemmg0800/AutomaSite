# ESTRUTURA VISUAL E CONTEÚDO DO SITE ORIGINAL: Instituto da Face do Amazonas (IFACEAM)
...
- **URL Original:** https://ifaceam.com.br/
- **Visual Quality Score:** 6.3/10 (B — BOM, MAS DESATUALIZADO)
- **Redesign Opportunity Score:** 66/100
...
- **Headline Identificada:** "Instituto da Face do Amazonas (IFACEAM) — Especialistas em Cirurgia Buco-Maxilo-Facial, DTM & Implantes Complexos"
...
- **Título da Seção:** "Por que escolher a Instituto da Face do Amazonas (IFACEAM)?"
...
- **Elementos:** Endereço físico completo (Av. Darcy Vargas, 654 - Parque 10 de Novembro, Manaus - AM), WhatsApp direto, telefone fixo, e-mail comercial e mapa de atendimento.
...
3. **NÃO REGRESSÃO:** É expressamente proibido trocar fotos reais por ilustrações ou mockups sem foto. O novo Hero precisa igualar ou superar nota 5.4/10.
