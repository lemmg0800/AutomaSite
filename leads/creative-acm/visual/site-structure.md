# ESTRUTURA VISUAL E CONTEÚDO DO SITE ORIGINAL: Creative ACM Comunicação Visual
...
- **Headline Identificada:** "Creative ACM Comunicação Visual — Especialistas em Fachadas em ACM, Letreiros Luminosos & Estruturas Metálicas"
...
- **Título da Seção:** "Por que escolher a Creative ACM Comunicação Visual?"
...
- **Elementos:** Endereço físico completo (Av. Centenário, Criciúma - SC), WhatsApp direto, telefone fixo, e-mail comercial e mapa de atendimento.
- **CTA Final:** "Solicite um Orçamento sem Compromisso".

---

## 3. DIRETRIZES MANDATÓRIAS PARA O BUILDER
1. **PRESERVAR:** Fotografias reais do acervo da empresa (77 fotos reais catalogadas); Paleta de cores institucional autêntica e logotipo original; Histórico, segmento de atuação e autoridade comprovada no mercado regional; Lista legítima de especialidades e projetos executados.
